...
Generated: `2026-05-14 09:39:49`

## Scope

- Source root: `src/`
- Python modules indexed: `51`
- Total Python lines (physical): `16789`
...
| `src/core/plasticity.py` | `src.core.plasticity` | 246 | 1 | 7 | Utilities for preparing plasticity solver inputs. |
...
| `src/file_io/loaders.py` | `src.file_io.loaders` | 917 | 0 | 21 | File loading helpers for MARS (Modal Analysis Response Solver). |
...
| `src/solver/engine.py` | `src.solver.engine` | 1967 | 2 | 0 | No module docstring. |
| `src/solver/plasticity_engine.py` | `src.solver.plasticity_engine` | 819 | 1 | 25 | Plasticity correction solvers for Neuber, Glinka, and IBG methods. |
...
| `src/ui/display_tab.py` | `src.ui.display_tab` | 755 | 1 | 0 | Refactored Display Tab for 3D visualization. |
| `src/ui/handlers/analysis_handler.py` | `src.ui.handlers.analysis_handler` | 1588 | 2 | 0 | Analysis Handler for the SolverTab. |
| `src/ui/handlers/display_animation_handler.py` | `src.ui.handlers.display_animation_handler` | 742 | 1 | 0 | Animation lifecycle management for the Display tab. |
| `src/ui/handlers/display_base_handler.py` | `src.ui.handlers.display_base_handler` | 133 | 1 | 0 | Base utilities for Display tab handler classes. |
...
| `src/ui/handlers/display_file_handler.py` | `src.ui.handlers.display_file_handler` | 103 | 1 | 0 | File loading logic for the Display tab. |
| `src/ui/handlers/display_interaction_handler.py` | `src.ui.handlers.display_interaction_handler` | 785 | 1 | 0 | Node interaction, picking, and hotspot analysis for the Display tab. |
| `src/ui/handlers/display_results_handler.py` | `src.ui.handlers.display_results_handler` | 610 | 1 | 0 | Helpers for applying solver output datasets to the Display tab. |
| `src/ui/handlers/display_state.py` | `src.ui.handlers.display_state` | 54 | 1 | 0 | Shared state container for the Display tab. |
| `src/ui/handlers/display_visualization_handler.py` | `src.ui.handlers.display_visualization_handler` | 420 | 1 | 0 | Visualization updates and rendering helpers for the Display tab. |
