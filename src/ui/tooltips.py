...
STEADY_STATE_CHECKBOX = (
    ...
    "<b>Expected file format:</b>&nbsp;&nbsp;.txt&nbsp;&nbsp;(tab-delimited)<br>"
    "<pre style='font-family: Consolas; font-size: 8pt; margin: 4px 0 0 0;'>"
    "Node Number&#9;SX (MPa)&#9;SY (MPa)&#9;SZ (MPa)&#9;SXY (MPa)&#9;SYZ (MPa)&#9;SXZ (MPa)</pre>"
    "<br>Supports text exports from <b>ANSYS Mechanical Vector Principal Stress</b> objects.<br>"
    "For accepted input, set ANSYS Mechanical export options as shown:<br>"
    "<ul style='margin-top: 2px; margin-bottom: 0;'>"
    "<li>Remove Duplicate Nodes = Yes</li>"
    "<li>Include Node Numbers = Yes</li>"
    "<li>Include Node Location = Yes</li>"
    "<li>Show Tensor Components = Yes</li>"
    "</ul><br>"
...
STEADY_STATE_FILE_BUTTON = (
    ...
    "<pre style='font-family: Consolas; font-size: 8pt; margin: 4px 0 0 0;'>"
    "Node Number&#9;SX (MPa)&#9;SY (MPa)&#9;SZ (MPa)&#9;SXY (MPa)&#9;SYZ (MPa)&#9;SXZ (MPa)</pre>"
    "<br>Compatible with exported text files from "
    "<b>ANSYS Mechanical Vector Principal Stress</b> objects.<br>"
    "<b>Set ANSYS export options:</b><br>"
    "<ul style='margin-top: 2px; margin-bottom: 0;'>"
    "<li>Remove Duplicate Nodes = Yes</li>"
    "<li>Include Node Numbers = Yes</li>"
    "<li>Include Node Location = Yes</li>"
